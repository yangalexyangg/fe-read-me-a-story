...
{:else if books.length > 0}
	<ul class="lg:flex flex-wrap justify-center gap-5 lg:mx-80 items-stretch">
		{#each books as book}
			<a
			...
			>
				<li
					class="shrink m-auto mb-5 mt-5 max-w-xs rounded border-8 border-solid border-[#b9f6ca] bg-amber-100 py-5 text-center lg:p-4"
				>
